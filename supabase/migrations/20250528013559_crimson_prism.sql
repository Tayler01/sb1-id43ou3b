/*
  # Update LARP table policies for global access

  1. Changes
    - Ensure public read access for all users
    - Maintain data consistency with proper constraints
    - Add indexes for better performance

  2. Security
    - Enable RLS with proper policies
    - Allow public read access to ensure global state
*/
