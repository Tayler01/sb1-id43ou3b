/*
  # Fix downvotes table structure and policies

  1. Changes
    - Drop and recreate downvotes table with proper structure
...
CREATE INDEX downvotes_kol_id_idx ON downvotes(kol_id);
CREATE INDEX downvotes_round_idx ON downvotes(round);
CREATE INDEX downvotes_count_idx ON downvotes(count DESC);
